...
public interface Files {
	 ...
	 * @return OK if success. FORBIDDEN if the token is incorrect. BAD_REQUEST otherwise.
	 */
	 ...
	 * @param fileId - unique id of the file.
	 * @param token  - token for accessing the file server (in the first project this will not be used).
	 * @return OK if success; NOT_FOUND if the fileId does not exist. FORBIDDEN if the token is incorrect. BAD_REQUEST
	 * otherwise.
	 */
