...
public interface Users {
	 ...
	 * @return 200 the userId. 409 if the user id already exists. 400 otherwise.
	 */
	 ...
	 * @return 200 the user object, if the userId exists and password matches the existing password 403 if the password
	 ...
	 * @return 200 the updated user object, if the name exists and password matches the existing password 403 if the
	 ...
	 * @param userId   the userId of the user
	 * @param password password of the user
	 * @return 200 the deleted user object, if the name exists and pwd matches the existing password 403 if the password
	 * is incorrect 404 if no user exists with the provided userId
	 */
	 ...
	 * @return 200 when the search was successful, regardless of the number of hits (including 0 hits). 400 otherwise.
	 */
