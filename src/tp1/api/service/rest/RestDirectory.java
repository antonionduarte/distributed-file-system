...
public interface RestDirectory {
	 ...
	 * @return 200 if success + FileInfo representing the file. 404 if the userId does not exist. 403 if the password is
	 * incorrect. 400 otherwise.
	 */
	@POST
	 ...
	 * @param userId   - id of the user.
	 * @param password - the password of the user.
	 * @return 204 if success; 404 if the userId or filename does not exist. 403 if the password is incorrect. 400
	 * otherwise.
	 */
	@DELETE
	@Path("/{userId}/{filename}")
	 ...
	 * @param password    - the password of the user.
	 * @return 204 if success; 404 if the userId or userIdShare or filename does not exist. 403 if the password is
	 * incorrect. 400 otherwise.
	 */
	@POST
	 ...
	 * @return 200 if success + contents (through redirect to the File server); 404 if the userId or filename or
	 * accUserId does not exist. 403 if the password is incorrect or the user cannot access the file. 400 otherwise.
	 */
	@GET
	@Path("/{userId}/{filename}")
	 ...
	 * @param userId   - id of the user.
	 * @param password - the password of the user.
	 * @return 200 if success + list of FileInfo; 404 if the userId does not exist. 403 if the password is incorrect.
	 * 400 otherwise.
	 */
	@GET
	@Path("/{userId}")
